            ...
            <div className="content">
              ...
              <div className="service-items">
                ...
                <div className="service-col">
                  <div className="service-item">
                    <div className="icon">
                      <i className="icon fas fa-headphones"></i>
                    </div>
                    <div className="name">
                      Music <br />
                      Writing
                    ...
                    <div className="single-post-text">
                      <p>
                        ...
                        classNameical music is notated so that it can be learned
                        and performed by solo singers.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="service-col">
                  <div className="service-item">
                    ...
                    <div className="single-post-text">
                      <p>
                        Come Up With a Game Idea. An idea is the first thing
                        that comes to mind when a game is being described before
                        creating.
                      </p>
                    </div>
                  </div>
                ...
                <div className="service-col">
                  <div className="service-item">
                    ...
                    <div className="name">
                      Photography <br />& Video
                    </div>
                    <div className="single-post-text">
                      <p>
                        Sessions. If you are a photographer that spends most of
                        the time in a portrait studio, you can charge for your
                        session.
                      </p>
                    </div>
                  </div>
